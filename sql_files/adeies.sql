...
START TRANSACTION;
USE `adeies_db`;
INSERT INTO `adeies_db`.`ypallhlos` (`ypallhlosid`, `genikidid`, `dieuthinsiid`, `tmimaid`, `onoma`, `epitheto`, `max_adeies`, `fylo`, `idiotita_id`, `ypoloipo_adeion_trexon`, `ypoloipo_adeion_palio`, `username`, `password`) VALUES (0, 0, 0, 0, 'Δοκιμαστικός', 'Υπάλληλος', '7', 0, 0, 7, 7, 'ypallhlos', 'ypallhlos');
INSERT INTO `adeies_db`.`ypallhlos` (`ypallhlosid`, `genikidid`, `dieuthinsiid`, `tmimaid`, `onoma`, `epitheto`, `max_adeies`, `fylo`, `idiotita_id`, `ypoloipo_adeion_trexon`, `ypoloipo_adeion_palio`, `username`, `password`) VALUES (1, 0, 0, 0, 'Δοκιμαστικός', 'Προϊστάμενος', '12', 0, 1, 12, 12, 'proistamenos', 'proistamenos');
INSERT INTO `adeies_db`.`ypallhlos` (`ypallhlosid`, `genikidid`, `dieuthinsiid`, `tmimaid`, `onoma`, `epitheto`, `max_adeies`, `fylo`, `idiotita_id`, `ypoloipo_adeion_trexon`, `ypoloipo_adeion_palio`, `username`, `password`) VALUES (2, 0, 0, 0, 'Δοκιμαστικός', 'Διευθυντής', '22', 1, 2, 22, 22, 'dieuthintis', 'dieuthintis');
INSERT INTO `adeies_db`.`ypallhlos` (`ypallhlosid`, `genikidid`, `dieuthinsiid`, `tmimaid`, `onoma`, `epitheto`, `max_adeies`, `fylo`, `idiotita_id`, `ypoloipo_adeion_trexon`, `ypoloipo_adeion_palio`, `username`, `password`) VALUES (3, 0, 0, 0, 'Δοκιμαστικός', 'Γενικός Διευθυντής', '25', 1, 3, 25, 25, 'genikosd', 'genikosd');
INSERT INTO `adeies_db`.`ypallhlos` (`ypallhlosid`, `genikidid`, `dieuthinsiid`, `tmimaid`, `onoma`, `epitheto`, `max_adeies`, `fylo`, `idiotita_id`, `ypoloipo_adeion_trexon`, `ypoloipo_adeion_palio`, `username`, `password`) VALUES (4, 0, 0, 0, 'Δοκιμαστικός', 'Εκτελεστικός', '35', 0, 4, 35, 35, 'ektelestikos', 'ektelestikos');
INSERT INTO `adeies_db`.`ypallhlos` (`ypallhlosid`, `genikidid`, `dieuthinsiid`, `tmimaid`, `onoma`, `epitheto`, `max_adeies`, `fylo`, `idiotita_id`, `ypoloipo_adeion_trexon`, `ypoloipo_adeion_palio`, `username`, `password`) VALUES (5, 0, 0, 0, 'Δοκιμαστικός', 'Περιφερειάρχης', '45', 0, 5, 45, 45, 'perifereiarxhs', 'perifereiarxhs');
