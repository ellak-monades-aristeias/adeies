...
INSERT INTO `adeies_db`.`idiotites` (`idiotita_id`, `idname`) VALUES (3, 'Εκτελεστικός Γραμματέας');
INSERT INTO `adeies_db`.`idiotites` (`idiotita_id`, `idname`) VALUES (4, 'Αντιπεριφερειάρχης');
...
START TRANSACTION;
USE `adeies_db`;
INSERT INTO `adeies_db`.`ypallhlos` (`ypallhlosid`, `genikidid`, `dieuthinsiid`, `tmimaid`, `onoma`, `epitheto`, `max_adeies`, `fylo`, `idiotita_id`, `ypoloipo_adeion_trexon`, `ypoloipo_adeion_palio`, `username`, `password`) VALUES (0, 0, 0, 0, 'Γεώργιος', 'Νικολάου', '7', 0, 0, 7, 7, 'testuser', 'testuser');
INSERT INTO `adeies_db`.`ypallhlos` (`ypallhlosid`, `genikidid`, `dieuthinsiid`, `tmimaid`, `onoma`, `epitheto`, `max_adeies`, `fylo`, `idiotita_id`, `ypoloipo_adeion_trexon`, `ypoloipo_adeion_palio`, `username`, `password`) VALUES (1, 0, 0, 0, 'Κωνσταντίνος', 'Ιωάννου', '12', 0, 1, 12, 12, 'testadmin', 'testadmin');
